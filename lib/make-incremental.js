 ...
 * @returns {CompareResult} Result of comparing <code>propName</code> values, up
 ...
 * stream.
 * @returns {function(!module:stream-compare.StreamState,
 * !module:stream-compare.StreamState): CompareResult} Incremental
